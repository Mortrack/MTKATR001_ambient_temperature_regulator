...
/**@file
 * 
 * @defgroup UART_ETX_OTA_Protocol_Factory UART ETX OTA Protocol Concrete Creator module
 * @{
 * 
 ...
 *          the @ref UART_ETX_OTA_Protocol Object for this particular case.
 * 
 ...
 *          an ETX OTA Payload via the UART Hardware Protocol to a desired slave
 *          device.
 * 
 ...
 *          @ref UART_ETX_OTA_Protocol Create Product.
 * 
 * @author  Cesar Miranda Meza (cmirandameza3@hotmail.com)
 * @date    December 28, 2023.
 */
public class UartEtxOtaProtocolFactory extends EtxOtaProtocolFactory {
     ...
     */
    public UartEtxOtaProtocolFactory(short pComportNumber) {
     ...
     * @date    December 28, 2023.
     */
    public UartEtxOtaProtocolFactory(
     ...
     *              <li>Delay in microseconds before calling the RS232_PollComport() function that is used in the PcTool UART API</li>
    ...
    /**
     * {@inheritDoc}
     * @return  {@link com.mortrack.hostbleapp.etxotaprotocol.UartEtxOtaProtocol}
     *          Concrete Product Object Instance.
     */
    @Override
    public com.mortrack.hostbleapp.etxotaprotocol.EtxOtaProtocol createProtocolInstance() {
        return new UartEtxOtaProtocol(
