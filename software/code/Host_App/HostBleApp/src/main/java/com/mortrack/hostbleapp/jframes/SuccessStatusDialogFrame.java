...
/**@file
 * 
 * @defgroup Success_Status_Dialog_Frame Success Status Dialog Frame module
 * @{
 * 
 * @brief   This module contains the methods and event handlers required to
 *          generate and show to the user a Success Status Dialog Frame as part
 *          of the UI so that this UI can show Success Messages to the user.
 * 
 * @details The following gives a friendly code example of how to use
 *          {@link com.mortrack.hostbleapp.jframes.SuccessStatusDialogFrame}
 *          Class, which is easily achieved with a single code of line:
 * @code
   new SuccessStatusDialogFrame("The requested Payload has been successfully sent to the slave device.", this); // Call this from wherever you want from the MainFrame Class.
 * @endcode
 * 
 ...
 *          visible and to handle the events of the Success Status Dialog Frame
 *          of UI.
 * 
 * @author  Cesar Miranda Meza (cmirandameza3@hotmail.com)
 * @date    November 08, 2023.
 */
public class SuccessStatusDialogFrame extends javax.swing.JFrame {
     ...
     *          mouse.
     */
    private static final Color OK_BUTTON_BG_CLICK_COLOR = new Color(2,48,25);
    
    /**@brief   Color Object containing the RBG color designated for the Border
     *          of the OK Button.
     */
    private static final Color OK_BUTTON_BORDER_COLOR = new Color(0,102,51);
     ...
     *          {@link com.mortrack.hostbleapp.jframes.SuccessStatusDialogFrame#jLabelMessageRow1})
     *          of the Body of the Success Status Dialog Frame.
     */
    private final String MESSAGE;
    
    /**@brief   JFrame Class from which the Success Status Dialog Frame was
     *          called from.
     */
     ...
     * @date    November 08, 2023.
     */
    public SuccessStatusDialogFrame(String message, MainFrame callingClass) {
        this.MESSAGE = message;
        this.CALLING_CLASS = callingClass;
        this.CALLING_CLASS.setEnabled(false);
        initComponents();
        jLabelMessageRow1.setText(this.MESSAGE);
    ...
    private void initComponents() {
        ...
        jLabelCheckIcon.setIcon(new javax.swing.ImageIcon("C:\\Users\\cmira\\OneDrive\\Escritorio\\Bootloader Project v0.4\\Host_BLE_App\\HostBleApp\\img\\StatusStatusDialog_CheckIcon.png")); // NOI18N
        ...
        jLabelSuccessMessage.setText("Success!");

        jPanelOkButton.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 51), 2));
        ...
        jLabelButtonOk.setForeground(new java.awt.Color(0, 102, 51));
     ...
     *          {@link com.mortrack.hostbleapp.jframes.SuccessStatusDialogFrame#jPanelOkButton}
     ...
     *          {@link com.mortrack.hostbleapp.jframes.SuccessStatusDialogFrame#CALLING_CLASS}
     *          will be enabled again and the current Object from this
     *          {@link com.mortrack.hostbleapp.jframes.SuccessStatusDialogFrame}
