...
#define MAJOR 										(1)										/**< @brief Major version number of our MCU/MPU's Pre-Bootloader Firmware. */
#define MINOR 										(0)										/**< @brief Minor version number of our MCU/MPU's Pre-Bootloader Firmware. */
/* USER CODE END PD */
